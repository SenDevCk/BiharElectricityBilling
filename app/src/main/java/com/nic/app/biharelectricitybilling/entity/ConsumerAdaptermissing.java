...
public class ConsumerAdaptermissing extends ArrayAdapter<MRUDetailsmissingconsumer> {
    Context context;
    int layoutResourceId;
    String fileName;


    ArrayList<MRUDetailsmissingconsumer> data = new ArrayList<MRUDetailsmissingconsumer>();

    public ConsumerAdaptermissing(Context context, int layoutResourceId,
                                  ArrayList<MRUDetailsmissingconsumer> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MRUDetailsmissingconsumer mru = data.get(position);
