package com.nic.app.biharelectricitybilling.contentProvider;
...
public class BillingIMEIProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.nic.app.biharelectricitybilling.contentProvider.BillingIMEIProvider";
