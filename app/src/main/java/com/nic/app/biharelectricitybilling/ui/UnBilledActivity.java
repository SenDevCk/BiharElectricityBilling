...
public class UnBilledActivity extends Activity {
    private ActionBar actionBar;
    DataBaseHelper localDBHelper;
    TextView mruName,noOfRecords, totalCon,billed,unBilled,accountNo,conName,address,fathername,category_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Database Opening
        localDBHelper = new DataBaseHelper(UnBilledActivity.this);
    ...
    public void addData() {
        ...
        for (Report rept : ReportList) {
            ...
            row.setOnClickListener(v -> {
                ...
                ReportList = localDBHelper.getUnBilledList();
                if(ReportList != null){
