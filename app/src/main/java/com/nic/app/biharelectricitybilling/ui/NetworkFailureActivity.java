...
public class NetworkFailureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Database Opening
        localDBHelper = new DataBaseHelper(NetworkFailureActivity.this);
        ...
        actionBar.setTitle(Html.fromHtml("<font color='#FFFFFF'>Network Failure Report</font>"));
        ...
        ReportList = localDBHelper.getNetworkFailureList();
        if(ReportList != null){
