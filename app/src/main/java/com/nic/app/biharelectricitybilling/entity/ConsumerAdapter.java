...
public class ConsumerAdapter extends ArrayAdapter<MRUDetails> {
    Context context;
    ...
    public ConsumerAdapter(Context context, int layoutResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvAddress.setText(mru.get_Cfathername()+" "+mru.get_BILL_ADDRESS());
        if(mru.get_isPrinted()!=null){
            if( mru.get_isPrinted().equalsIgnoreCase("Y") || mru.get_APL_CONSUMER().equalsIgnoreCase("Y")){
