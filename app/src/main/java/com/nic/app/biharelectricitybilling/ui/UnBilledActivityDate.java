...
public class UnBilledActivityDate extends Activity {

    private ActionBar actionBar;
    DataBaseHelper localDBHelper;
    TextView mruName,noOfRecords, totalCon,billed,unBilled,accountNo,conName,address,fathername,lastbilldate,category_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unbilled_datewise);

        // Database Opening
        localDBHelper = new DataBaseHelper(UnBilledActivityDate.this);
        ...
        actionBar.setTitle(Html.fromHtml("<font color='#FFFFFF'>Unbilled Report</font>"));
        ...
        ReportList = localDBHelper.getUnBilledReport();
        if(ReportList != null){
    ...
    public void addData() {
        ...
        for (Report rept : ReportList) {
            ...
            row.setOnClickListener(v -> {
                ...
                ReportList = localDBHelper.getUnBilledListdatewise();
                if(ReportList != null){
           ...
           /* pending.setLayoutParams(new TableRow.LayoutParams(
            ...
            unBilled = new TextView(getApplicationContext());
            unBilled.setText(rept.get_UnBilled());
            // tvCandidateName2.setText(distrpt.getRcpt_amount_Paddy());
            unBilled.setTextColor(Color.WHITE);
            unBilled.setBackgroundResource(R.drawable.cell_shape2);
            // tvCandidateName2.setMinLines(3);
            unBilled.setGravity(Gravity.CENTER);
            unBilled.setTextSize(14);
            unBilled.setTypeface(Typeface.DEFAULT, Typeface.NORMAL);
           /* billedAmt.setLayoutParams(new TableRow.LayoutParams(
                    rowHeader.getChildAt(3).getMeasuredWidth(), ViewGroup.LayoutParams.MATCH_PARENT));*/
            unBilled.setPadding(10, 5, 5, 5);

            row.addView(unBilled);
    ...
    public void addDataForList() {
       ...
       Log.e("Unmeter",rept.get_AccountNo()+","+rept.getUnmeter());
           ...
           /* pending.setLayoutParams(new TableRow.LayoutParams(
            ...
            category_name = new TextView(getApplicationContext());
            category_name.setText(rept.get_CategoryName());
            // tvCandidateName2.setText(distrpt.getRcpt_amount_Paddy());
            category_name.setTextColor(Color.WHITE);
            category_name.setBackgroundResource(R.drawable.cell_shape2);
            // tvCandidateName2.setMinLines(3);
            category_name.setGravity(Gravity.CENTER);
            category_name.setTextSize(14);
            category_name.setTypeface(Typeface.DEFAULT, Typeface.NORMAL);
           /* pending.setLayoutParams(new TableRow.LayoutParams(
                    rowHeader.getChildAt(3).getMeasuredWidth(), ViewGroup.LayoutParams.MATCH_PARENT));*/
            category_name.setPadding(10, 15, 5, 15);

            row.addView(category_name);
...
//adding consumer father's name
            ...
            lastbilldate = new TextView(getApplicationContext());
            lastbilldate.setText(rept.get_last_bill_date());
            // tvCandidateName2.setText(distrpt.getRcpt_amount_Paddy());
            lastbilldate.setTextColor(Color.WHITE);
            lastbilldate.setBackgroundResource(R.drawable.cell_shape2);
            // tvCandidateName2.setMinLines(3);
            lastbilldate.setGravity(Gravity.CENTER);
            lastbilldate.setTextSize(14);
            lastbilldate.setTypeface(Typeface.DEFAULT, Typeface.NORMAL);
           /* billedAmt.setLayoutParams(new TableRow.LayoutParams(
                    rowHeader.getChildAt(3).getMeasuredWidth(), ViewGroup.LayoutParams.MATCH_PARENT));*/
            lastbilldate.setPadding(10, 15, 5, 15);
            row.addView(lastbilldate);
